...
// holly sheet , what im i looking at 
// dont know this shit but it may work? 
...
/*
* x,z Local position from inside chunk
* chunkX, chunkZ is location of chunk inside world 
* World = noice map ( 256 x 256 )
*/
